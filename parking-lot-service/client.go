...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/parking-lot-service/gateway/parking-lot-service"
...
func GetClientGrpc(lnAddress string) pb.ParkingServiceClient {
	...
	defer client.Close()
	return pb.NewParkingServiceClient(client)
}
