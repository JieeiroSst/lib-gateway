...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/automatic-payment-service/gateway/automatic-payment-service"
...
func GetClientGrpc(lnAddress string) pb.PaymentGatewayServiceClient {
	...
	defer client.Close()
	return pb.NewPaymentGatewayServiceClient(client)
}
