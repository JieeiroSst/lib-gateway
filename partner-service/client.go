...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/partner-service/gateway/partner-service"
...
func GetClientGrpc(lnAddress string) pb.PartnershipServiceClient {
	...
	defer client.Close()
	return pb.NewPartnershipServiceClient(client)
}
