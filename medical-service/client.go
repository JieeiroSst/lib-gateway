...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/medical-service/gateway/medical-service"
...
func GetClientGrpc(lnAddress string) pb.MedicalRecordsServiceClient {
	...
	defer client.Close()
	return pb.NewMedicalRecordsServiceClient(client)
}
