...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/payer-service/gateway/payer-service"
...
func GetClientGrpc(lnAddress string) pb.TransactionServiceClient {
	...
	defer client.Close()
	return pb.NewTransactionServiceClient(client)
}
