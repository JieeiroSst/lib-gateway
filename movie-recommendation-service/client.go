...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/movie-recommendation-service/gateway/movie-recommendation-service"
...
func GetClientGrpc(lnAddress string) pb.MovieRecommendationServiceClient {
	...
	defer client.Close()
	return pb.NewMovieRecommendationServiceClient(client)
}
