...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/authorize-service/gateway/authorize-service"
...
func GetClientGrpc(lnAddress string) pb.AuthorizeServiceClient {
	...
	defer client.Close()
	return pb.NewAuthorizeServiceClient(client)
}
