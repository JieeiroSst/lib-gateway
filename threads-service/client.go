...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/threads-service/gateway/threads-service"
...
func GetClientGrpc(lnAddress string) pb.ThreadsServiceClient {
	...
	defer client.Close()
	return pb.NewThreadsServiceClient(client)
}
