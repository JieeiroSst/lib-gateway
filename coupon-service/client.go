...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/coupon-service/gateway/coupon-service"
...
func GetClientGrpc(lnAddress string) pb.CouponServiceClient {
	...
	defer client.Close()
	return pb.NewCouponServiceClient(client)
}