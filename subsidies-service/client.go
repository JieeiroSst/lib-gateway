...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/subsidies-service/gateway/subsidies-service"
...
func GetClientGrpc(lnAddress string) pb.DiscountProgramServiceClient {
	...
	defer client.Close()
	return pb.NewDiscountProgramServiceClient(client)
}
