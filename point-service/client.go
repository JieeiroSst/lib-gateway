...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/point-service/gateway/point-service"
...
func GetClientGrpc(lnAddress string) pb.RewardPointsServiceClient {
	...
	defer client.Close()
	return pb.NewRewardPointsServiceClient(client)
}
