...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/billing-service/gateway/billing-service"
...
func GetClientGrpc(lnAddress string) pb.SubscriptionServiceClient {
	...
	defer client.Close()
	return pb.NewSubscriptionServiceClient(client)
}
