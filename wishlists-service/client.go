...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/wishlists-service/gateway/wishlists-service"
...
func GetClientGrpc(lnAddress string) pb.WishlistServiceClient {
	...
	defer client.Close()
	return pb.NewWishlistServiceClient(client)
}
