...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/account-transaction-service/gateway/account-transaction-service"
...
func GetClientGrpc(lnAddress string) pb.BankingServiceClient {
	...
	defer client.Close()
	return pb.NewBankingServiceClient(client)
}
