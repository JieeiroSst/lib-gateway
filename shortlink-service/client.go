...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/shortlink-service/gateway/shortlink-service"
...
func GetClientGrpc(lnAddress string) pb.ShortlinkServiceClient {
	...
	defer client.Close()
	return pb.NewShortlinkServiceClient(client)
}
