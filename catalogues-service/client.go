...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/catalogues-service/gateway/catalogues-service"
...
func GetClientGrpc(lnAddress string) pb.CatalogServiceClient {
	...
	defer client.Close()
	return pb.NewCatalogServiceClient(client)
}
