...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/voucher-service/gateway/voucher-service"
...
func GetClientGrpc(lnAddress string) pb.VoucherServiceClient {
	...
	defer client.Close()
	return pb.NewVoucherServiceClient(client)
}
