...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/basket-service/gateway/basket-service"
...
func GetClientGrpc(lnAddress string) pb.BasketServiceClient {
	...
	defer client.Close()
	return pb.NewBasketServiceClient(client)
}
