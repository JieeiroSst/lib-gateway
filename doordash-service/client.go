...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/doordash-service/gateway/doordash-service"
...
func GetClientGrpc(lnAddress string) pb.FoodDeliveryGatewayClient {
	...
	defer client.Close()
	return pb.NewFoodDeliveryGatewayClient(client)
}
