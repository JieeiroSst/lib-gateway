...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/address-country-service/gateway/address-country-service"
...
func GetClientGrpc(lnAddress string) pb.AddressServiceClient {
	...
	defer client.Close()
	return pb.NewAddressServiceClient(client)
}
