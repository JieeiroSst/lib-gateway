...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/admanagement-service/gateway/admanagement-service"
...
func GetClientGrpc(lnAddress string) pb.AdmanagementServiceClient {
	...
	defer client.Close()
	return pb.NewAdmanagementServiceClient(client)
}
