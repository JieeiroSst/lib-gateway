...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/bonuslink-serivce/gateway/bonuslink-serivce"
...
func GetClientGrpc(lnAddress string) pb.BonuslinkSerivceClient {
	...
	defer client.Close()
	return pb.NewBonuslinkSerivceClient(client)
}
