...
type FileServiceClient interface {
	...
	GetFileContent(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*FileContentResponse, error)
...
func (c *fileServiceClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (*FileResponse, error) {
...
func (c *fileServiceClient) GetFileContent(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*FileContentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type FileServiceServer interface {
	...
	GetFileContent(context.Context, *GetFileRequest) (*FileContentResponse, error)
...
func (UnimplementedFileServiceServer) UploadFile(context.Context, *UploadFileRequest) (*FileResponse, error) {
...
func (UnimplementedFileServiceServer) GetFileContent(context.Context, *GetFileRequest) (*FileContentResponse, error) {
...
func _FileService_GetFileContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).GetFileContent(ctx, req.(*GetFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "cdn-service/service.proto",
}
