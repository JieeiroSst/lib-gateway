...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/vending-machine-service/gateway/vending-machine-service"
...
func GetClientGrpc(lnAddress string) pb.VendingMachineServiceClient {
	...
	defer client.Close()
	return pb.NewVendingMachineServiceClient(client)
}
