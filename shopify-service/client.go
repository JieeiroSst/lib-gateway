...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/shopify-service/gateway/shopify-service"
...
func GetClientGrpc(lnAddress string) pb.FlashSaleServiceClient {
	...
	defer client.Close()
	return pb.NewFlashSaleServiceClient(client)
}
