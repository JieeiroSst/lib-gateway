...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/ticket-service/gateway/ticket-service"
...
func GetClientGrpc(lnAddress string) pb.TicketManagementServiceClient {
	...
	defer client.Close()
	return pb.NewTicketManagementServiceClient(client)
}
