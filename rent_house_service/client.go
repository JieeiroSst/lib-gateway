...
import (
	...
	pb "github.com/JIeeiroSst/lib-gateway/rent_house_service/gateway/rent_house_service"
...
func GetClientGrpc(lnAddress string) pb.HomestayServiceClient {
	...
	defer client.Close()
	return pb.NewHomestayServiceClient(client)
}
